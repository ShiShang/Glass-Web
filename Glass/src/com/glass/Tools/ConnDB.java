...
public class ConnDB {
	...
	private static String dbUrl = "jdbc:mysql://127.0.0.1:3306/glass?user=root&password=1085&useUnicode=true";
	...
	public ResultSet executeQuery(String sql) {
		try { // 捕捉异常
			conn = getConnection(); // 调用getConnection()方法构造Connection对象的一个实例conn //这里调用了getConnection()方法，所以后续只要直接调用此方法即可；
